...
| E55 | 2026-02-18 | abs_hz_month_prior | CV SKF 0.6780 | 0.5672 | 0.9245 | 0.2830 | 0.5759 | 0.6758 | 0.9453 | 0.8355 | 0.7780 | 0.5167 | **Absolute-Hz wingbeat (E16 biology) + E54 month-specific Bayesian post-processing.** Fresh training (no pre-computed predictions) with 131 features: core+flight_mode+flight_physics+weakclass+absolute_wingbeat+linearity+tabular (ALL_TEMPORAL dropped). LGB(40%)+XGB(30%)+CB(30%) with minority oversampling. Then applied E54 GBIF prior adjustment for unseen months {2,5,12}. Outputs: base `e55_base_0.6780_20260218_2249.csv`, `e55_spring_tilt_...csv`, `e55_winter_tilt_...csv`. Note: CV is honest SKF without temporal features; absolute wingbeat bands did not improve over E50 baseline (0.6780 < 0.6808). |
