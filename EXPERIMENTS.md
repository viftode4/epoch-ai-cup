...
| E69 | 2026-02-22 | e42_with_priors | LB TBD | -- | -- | -- | -- | -- | -- | -- | -- | -- | **Apply E54 winter_tilt priors to E42 base (LOMO 0.3799) instead of E50 (0.3625).** 4 variants: A=winter_tilt(m2=0.22,m5=0.12,m12=0.24), B=stronger_winter(m2=0.26,m5=0.12,m12=0.28), C=spring_tilt(m2=0.15,m5=0.28,m12=0.15), D=moderate(m2=0.20,m5=0.10,m12=0.22). Prior adjustments shift Feb: Gulls-0.067, Ducks+0.045, Waders+0.024; Dec: Gulls-0.074, Ducks+0.052, Waders+0.031; May: Songbirds+0.065, Gulls-0.045. Submit A first to test if better base helps. |
